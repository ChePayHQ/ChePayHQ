...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses += ["rp1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju70y7twz", "rp1qfqeppuvj0ww98r6qghmdkj70tv8qpcheg9f0wk"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'rp1qtmp74ayg7p24uslctssvjm06q5phz4yreqey4a', # m/0'/0'/0
            'rp1q8vprchan07gzagd5e6v9wd7azyucksq2eylksk', # m/0'/0'/1
            'rp1qtuqdtha7zmqgcrr26n2rqxztv5y8rafj7e7sed', # m/0'/0'/2
            'rp1qau64272ymawq26t90md6an0ps99qkrsetm6kn7', # m/0'/0'/3
            'rp1qsg97266hrh6cpmutqen8s4s962aryy77daw9w7', # m/0'/0'/4
        ]
        ...
        assert_equal(addr, 'rp1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqnvkthg') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32')
        assert_equal(change_addr, 'rp1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lnsapp05k')
        ...
        assert_equal(addr, 'rp1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeq2w0ss2') # Derived at m/84'/0'/0'/1

...
const char * const BITCOIN_CONF_FILENAME = "chepay.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ChePay";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/ChePay";
#else
    // Unix-like
    return pathRet / ".chepay";
#endif
#endif
}

...
{
    const char* pszTimestamp = "CheyPay was born 4/13/2026";
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 2800000;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartHeight = 0; // Activate from genesis on this fork
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeoutHeight = 2370816; // 364 days later

        // Deployment of MWEB (LIP-0002, LIP-0003, and LIP-0004)
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartHeight = 0; // Activate from genesis on this fork
        ...
        vSeeds.clear();
        vSeeds.emplace_back("chepay-node1.duckdns.org");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1776038402, 0, 0x207fffff, 1, 0);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6fa70e09f0eb6e8b20b9232539a5432f7d195c47a5102d58813bcc9262818499"));
        assert(genesis.hashMerkleRoot == uint256S("0xb4c768f07f16bb015602e767386c2a653f83b5b4da44b762315628573c623577"));

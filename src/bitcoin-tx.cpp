...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " litecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  litecoin-tx [options] <hex-tx> [commands]  Update hex-encoded ChePay transaction\n" +
            "or:     litecoin-tx [options] -create [commands]   Create hex-encoded ChePay transaction\n" +
            "\n";

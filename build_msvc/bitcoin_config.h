...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The ChePay Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "ChePay Core"
...
#define PACKAGE_NAME "ChePay Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ChePay Core 0.21.3"

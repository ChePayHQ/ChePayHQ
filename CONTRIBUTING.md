Contributing to ChePay Core
============================

The ChePay Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the ChePay Core build
...
The following applies to code changes to the ChePay Core project (and related
projects such as libsecp256k1), and is not to be confused with overall ChePay
Network Protocol consensus changes.

Whether a pull request is merged into ChePay Core rests with the project merge
...
Patches that change ChePay consensus rules are considerably more involved than
...
Where a patch set proposes to change the ChePay consensus, it must have been
...
The project leader is the release manager for each ChePay Core release.

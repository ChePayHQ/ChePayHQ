# Support for Output Descriptors in ChePay Core

Since ChePay Core v0.17, there is support for Output Descriptors. This is a
...
existing ChePay Core wallets, a convenience function `combo` is

...
### ChePay maintainers/release engineers, suggestion for writing release notes
...
### Build and sign ChePay Core for Linux, Windows, and macOS:
...
Codesigner only: Sign the macOS binary:
    ...
    $   xcrun altool --notarize-app --primary-bundle-id "org.litecoin.ChePay-Qt" -u "<apple-id-email>" -p "@keychain:<apple-id-notarisation-app-specific-password>" --asc-provider <team-id-shortcode> -t osx -f litecoin-${VERSION}-osx.dmg
    ...
    $   xcrun stapler staple dist/ChePay-Qt.app
...
Codesigner only: Commit the detached codesign payloads:
    ...
    cp dist/ChePay-Qt.app/Contents/CodeResources osx/dist/ChePay-Qt.app/Contents/
    git add -A
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/ChePay, ... but this will usually sort out itself
